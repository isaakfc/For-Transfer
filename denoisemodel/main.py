...
# Paths for data
SPECTROGRAMS_PASSAGES_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/CLEANSPECTROGRAMS"
SPECTROGRAMS_RECREATIONS_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/NOISYSPECTROGRAMS"

# Load spectrograms
x_clean = load.load_data_set(SPECTROGRAMS_PASSAGES_PATH)[:2000]
x_noisy = load.load_data_set(SPECTROGRAMS_RECREATIONS_PATH)[:2000]
...
GENERATOR_LEARNING_RATE = 1e-8    # Range from about  0.0001 to 0.1
DISCRIMINATOR_LEARNING_RATE = 1e-4    # Range from about  0.0001 to 0.1
...
BATCH_SIZE = 30     # Range from 16 to 512 (for audio from about 8 to 128)
...
N_CRITIC = 2  # Train critic(discriminator) n times then train generator 1 time.
...
current_learning_rate = GENERATOR_LEARNING_RATE
trace = True
n_critic_count = 0
...
for e in range(1, EPOCHS+1):
    ...
    if e == 1 or e % 5 == 0:
        ...
        audiogeneration.convert_spectrograms_to_audio(e,
                                                      ...
                                                      FRAME_SIZE,
                                                      SR)
        audiogeneration.convert_spectrograms_to_audio2(e,
                                                      x_real_batch,
                                                      overall_max,
                                                      overall_min,
                                                      HOP_LENGTH,
                                                      FRAME_SIZE,
                                                      SR)
        audiogeneration.convert_spectrograms_to_audio3(e,
                                                       x_noisy_batch,
                                                       overall_max,
                                                       overall_min,
                                                       HOP_LENGTH,
