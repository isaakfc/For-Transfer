...
class PadderSegmenter:
    ...
    def segment_and_pad(self, audio):
        """
        Segment audio into fixed lengths and pad the last segment if needed.
        """
        num_samples = len(audio)
        num_segments = int(np.ceil(num_samples / self.segment_sample_length))

        # Create an array of zeros of shape (num_segments, segment_length)
...
class LogSpectrogramExtractor:
    ...
    def extract_segments(self, signals):
        # Assuming the singals variable is 2D numpy array where each row is a segment
...
if __name__ == "__main__":
    ...
    HOP_LENGTH = 256
    MONO = True
    PASSAGES_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/CLEANSAMPLES"
    RECREATIONS_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/NOISYSAMPLES"
    PROCESSED_PASSAGES_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/PROCESSEDCLEAN"
    PROCESSED_RECREATIONS_PATH = "/Users/isaac/Documents/DATASETS/DENOISE/PROCESSEDNOISY"
