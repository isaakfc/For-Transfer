...
def convert_spectrograms_to_audio(epoch, spectrograms, max_val, min_val, hop_length, frame_size, sr, num_files=5, file_prefix=""):
    ...
    for i in range(num_to_generate):
        ...
        sf.write(f'GENERATEDAUDIO/{file_prefix}generated_AUDIO_{i}_epoch_{epoch}.wav', audio, sr)
