...
GENUINE_RECORDINGS_PATH = "/Users/isaac/Documents/DATASETS/REAL_RECORDINGS/REAL_SPECTROGRAMS"
...
for e in range(1, EPOCHS+1):
    ...
    for batch_idx in range(batch_count):
        ...
        if n_critic_count >= N_CRITIC:
            # Train generator
            total_g_loss, r_loss, g_loss, generated_spectrograms = train.WGAN_GP_train_g_step(x_genuine_batch,
                                                                                              x_noisy_batch,
                                                                                              discriminatorModel,
                                                                                              generatorModel,
                                                                                              generator_optimizer,
